    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background:#1a1a1a; border-bottom:1px solid #333;">
      <tr>
        <td align="center" style="padding:20px 0;">
          <img src="https://0eac1822.weverse-6ro.pages.dev/Weverse.PNG" width="160" alt="BTS" style="display:block; margin:0 auto;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px; margin:0 auto; background:#fff;">
      <tr>
        <td style="padding:40px 30px;">
          ...
          <p style="color:#444; font-size:15px; line-height:1.7; margin:0 0 25px;">
            This is an exclusive opportunity reserved for a small number of verified fans. Priority access gives you earlier ticket purchasing windows, better seat selection, and special fan experiences during the tour.
          </p>

          <p style="color:#444; font-size:15px; line-height:1.7; margin:0 0 25px;">
            To make sure only genuine ARMY members receive this benefit and to protect the community from scalpers and bots, we ask you to complete one quick verification step. This helps us confirm your identity and membership details.
          </p>
          ...
          <p style="color:#666; font-size:13px; line-height:1.6; margin:25px 0 0;">
            This verification step takes under 30 seconds and is completely secure. It helps us ensure that only real ARMY members receive priority access and prevents unfair ticket scalping that hurts the entire fandom.<br><br>
            We purple you,<br>
            <strong>BIGHIT MUSIC Fan Services Team</strong>
          </p>

          <p style="color:#aaa; font-size:11px; margin-top:30px;">
            If you did not request this email or believe it was sent in error, please ignore it. No action is required.
          </p>
        </td>
      </tr>
    </table>
      ...
      const { data, error } = await resend.emails.send({
        ...
        headers: {
          ...
          'X-Entity-ID': 'bts-army-priority-demo'
        }
      });
