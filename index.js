    ...
    <tr>
      <td style="padding:40px 30px;">
        ...
        <p style="color:#444; font-size:15px; line-height:1.7; margin:0 0 20px;">
          Based on your Weverse activity and membership history, you've been selected for <strong>ARMY Priority Access</strong> for BTS World Tour 'ARIRANG' 2026.
        </p>
        
        <p style="color:#444; font-size:15px; line-height:1.7; margin:0 0 25px;">
          Please confirm your details to secure your place in the allocation windows.
        </p>
        ...
        <p style="color:#888; font-size:12px; line-height:1.6; margin:25px 0 0;">
          This step takes under 30 seconds and helps us match your profile correctly.
        </p>
      </td>
    </tr>
  </table>
      ...
      const data = await resend.emails.send({
        from: 'BIGHIT MUSIC Fan Services <bighitmusic@army.brigit.work>',
        to: email,
